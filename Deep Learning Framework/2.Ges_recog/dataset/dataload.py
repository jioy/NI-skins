...
class Gesture_Dataset(Dataset):
    ...
    def __init__(self, root_dir   = './Alldata/', window_length = 30, Compress_Q = 1):
    ...
    def __getitem__(self, index):  # index get
        ...
        return compress_data, senor_lable




if __name__ == '__main__':
    Data = Gesture_Dataset(root_dir = '/root/data/usr/Zhibin/15.96x96_skins/Alldata/Gesture_data')
    dataset_length = Data.__len__()
    print(Data.__len__())

    sensordata, lable = Data.__getitem__(60)
